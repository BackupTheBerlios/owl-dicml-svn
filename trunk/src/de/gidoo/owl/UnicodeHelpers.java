...
/**
 * Provides some functions to handle Unicode and masked characters.
...
public class UnicodeHelpers {
  ...
  /**
   * Masks all special-characters in the text in HTML-style (&amp;#x....;).
  ...
  /**
   * Unmasks all masked characters in the text.
   * @param text the string to convert
   * @return the converted string
   */
  ...
  /**
   * Convert strings with hexadecimal values (e.g. "04E4") to the corresponding long-values.
   * @param text the number as hexadecimal string
   * @return the number as long-value
   */
  ...
  /**
   * Converts a long to a string representating this value in hexadecimal format.
